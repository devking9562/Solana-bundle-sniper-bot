...
__export(src_exports, {
  ...
  ASSOCIATED_TOKEN_PROGRAM_ID: () => import_spl_token.ASSOCIATED_TOKEN_PROGRAM_ID,
  ...
  SYSVAR_CLOCK_PUBKEY: () => import_web33.SYSVAR_CLOCK_PUBKEY,
  SYSVAR_RENT_PUBKEY: () => import_web33.SYSVAR_RENT_PUBKEY,
  Spl: () => Spl,
  ...
  TOKEN_PROGRAM_ID: () => import_spl_token.TOKEN_PROGRAM_ID,
  TWO: () => TWO,
...
function perfectDisplay(value, deeping = false) {
  ...
  try {
    ...
    } else if (value instanceof import_web3.PublicKey) {
...
function notInnerObject(v) {
  return typeof v === "object" && v !== null && ![TokenAmount, import_web34.PublicKey, Fraction, import_bn.BN, Currency, CurrencyAmount, Price, Percent].some(
...
function poolKeys2JsonInfo(jsonInfo) {
  return jsonInfo instanceof import_web34.PublicKey ? jsonInfo.toBase58() : Array.isArray(jsonInfo) ? jsonInfo.map((k) => poolKeys2JsonInfo(k)) : notInnerObject(jsonInfo) ? Object.fromEntries(Object.entries(jsonInfo).map(([k, v]) => [k, poolKeys2JsonInfo(v)])) : jsonInfo;
}
...
function inspectBN() {
  import_bn2.default.prototype.inspect = function() {
...
function addComputeBudget(config) {
  ...
  if (config.microLamports) {
    ins.push(import_web36.ComputeBudgetProgram.setComputeUnitPrice({ microLamports: config.microLamports }));
    insTypes.push(9 /* setComputeUnitPrice */);
  }
  if (config.units) {
    ins.push(import_web36.ComputeBudgetProgram.setComputeUnitLimit({ units: config.units }));
...
function splitTxAndSigners(_0) {
  return __async(this, arguments, function* ({
    ...
    for (const item of allLTA) {
      if (lookupTableAddressAccount[item] === void 0) needCacheLTA.push(new import_web37.PublicKey(item));
    }
...
var ZERO = new import_bn3.default(0);
var ONE = new import_bn3.default(1);
 ...
 */
_Token.WSOL = new _Token(import_spl_token.TOKEN_PROGRAM_ID, WSOL.mint, WSOL.decimals, SOL.symbol, SOL.name);
var Token = _Token;
...
var Decimal = to_format_default(import_decimal.default);
...
var Spl = class {
  ...
  static makeCreateAssociatedTokenAccountInstruction({
    ...
    return (0, import_spl_token2.createAssociatedTokenAccountInstruction)(payer, associatedAccount, owner, mint, programId);
  }
  ...
  static makeCreateWrappedNativeAccountInstructions(_0) {
    return __async(this, arguments, function* ({
      ...
      const newAccount = generatePubKey({ fromPublicKey: payer, programId: import_spl_token.TOKEN_PROGRAM_ID });
      instructions.push(
  ...
  static makeInitMintInstruction({
    ...
    return (0, import_spl_token2.createInitializeMintInstruction)(mint, decimals, mintAuthority, freezeAuthority, programId);
  }
  static makeMintToInstruction({
    ...
    return (0, import_spl_token2.createMintToInstruction)(mint, dest, authority, BigInt(String(amount)), multiSigners, programId);
  }
  static makeInitAccountInstruction({
    ...
    return (0, import_spl_token2.createInitializeAccountInstruction)(tokenAccount, mint, owner, programId);
  }
  static makeTransferInstruction({
    ...
    return (0, import_spl_token2.createTransferInstruction)(source, destination, owner, BigInt(String(amount)), multiSigners, programId);
  }
  static makeCloseAccountInstruction({
    ...
    return (0, import_spl_token2.createCloseAccountInstruction)(tokenAccount, payer, owner, multiSigners, programId);
  }
  static createInitAccountInstruction(programId, mint, account, owner) {
    const keys = [
      ...
      {
        pubkey: import_web33.SYSVAR_RENT_PUBKEY,
        isSigner: false,
        isWritable: false
      }
    ];
...
function voterStakeRegistryCreateDepositEntry(programId, registrar, voter, voterVault, voterAuthority, payer, depositMint, depositEntryIndex, kind, startTs, periods, allowClawback) {
  ...
  const keys = [
    ...
    AccountMetaReadonly(SYSTEM_PROGRAM_ID, false),
    AccountMetaReadonly(import_spl_token.TOKEN_PROGRAM_ID, false),
    AccountMetaReadonly(import_spl_token.ASSOCIATED_TOKEN_PROGRAM_ID, false),
    AccountMetaReadonly(RENT_PROGRAM_ID, false)
  ];
  const data = Buffer.alloc(dataLayout.span);
  dataLayout.encode(
...
var Farm = class _Farm extends Base {
  ...
  static makeDepositInstructionV3({ poolKeys, userKeys, amount }) {
    ...
    const keys = [
      ...
      // system
      AccountMetaReadonly(import_web33.SYSVAR_CLOCK_PUBKEY, false),
      AccountMetaReadonly(import_spl_token.TOKEN_PROGRAM_ID, false)
    ];
  ...
  static makeCreateAssociatedLedgerAccountInstructionV3({
    ...
    const keys = [
      ...
      // system
      AccountMetaReadonly(SYSTEM_PROGRAM_ID, false),
      AccountMetaReadonly(import_web33.SYSVAR_RENT_PUBKEY, false)
    ];
    return {
      address: {},
      innerTransaction: {
  ...
  static makeCreateFarmInstructionV6(_0) {
    return __async(this, arguments, function* ({ connection, userKeys, poolInfo }) {
      ...
      for (const rewardInfo of poolInfo.rewardInfos) {
        ...
        const rewardMint = rewardInfo.rewardMint.equals(import_web315.PublicKey.default) ? Token.WSOL.mint : rewardInfo.rewardMint;
        rewardInfoKey.push({
          rewardMint,
  ...
  static makeCreatorWithdrawFarmRewardInstructionV6({
    ...
    const rewardInfo = poolKeys.rewardInfos.find(
      (item) => item.rewardMint.equals(withdrawMint.equals(import_web315.PublicKey.default) ? Token.WSOL.mint : withdrawMint)
    );
    ...
    return __async(this, arguments, function* ({
      ...
      if (withdrawMint.equals(import_web315.PublicKey.default)) {
        ...
        if (selectUserRewardToken === null) {
          userRewardToken = getATAAddress(userKeys.owner, withdrawMint, import_spl_token.TOKEN_PROGRAM_ID).publicKey;
          frontInstructions.push(
  ...
  static makeRestartFarmInstructionV6Simple(_0) {
    return __async(this, arguments, function* ({
      ...
      const rewardMint = newRewardInfo.rewardMint.equals(import_web315.PublicKey.default) ? Token.WSOL.mint : newRewardInfo.rewardMint;
  ...
  static makeFarmCreatorAddRewardTokenInstructionV6Simple(_0) {
    return __async(this, arguments, function* ({
      ...
      const rewardVault = _Farm.getAssociatedLedgerPoolAccount({
        programId: poolKeys.programId,
        poolId: poolKeys.id,
        mint: newRewardInfo.rewardMint.equals(import_web315.PublicKey.default) ? Token.WSOL.mint : newRewardInfo.rewardMint,
        type: "rewardVault"
      });
      const frontInstructions = [];
      const endInstructions = [];
  ...
  static makeDepositTokenInstruction(_0) {
    return __async(this, arguments, function* ({
      ...
      const voterVault = getATAAddress(voter, votingMint, import_spl_token.TOKEN_PROGRAM_ID).publicKey;
      ...
      const instructions = [];
      const depositToken = getATAAddress(owner, votingMint, import_spl_token.TOKEN_PROGRAM_ID).publicKey;
    ...
    return __async(this, arguments, function* ({
      ...
      instructions.push(
        voterStakeRegistryWithdraw(
          ...
          voterWeightRecord,
          voterVault,
          getATAAddress(owner, votingMint, import_spl_token.TOKEN_PROGRAM_ID).publicKey,
          ownerPda,
          poolId,
          votingMint,
          votingMintAuthority,
  ...
  static updatePoolRewardInfos(_0) {
    return __async(this, arguments, function* ({
      ...
      for (let i = 0; i < rewardInfos.length; i++) {
        ...
        if (itemReward.tokenMint.equals(import_web317.PublicKey.default)) continue;
...
var MathUtil = class {
  ...
  static x64ToDecimal(num, decimalPlaces) {
    return new import_decimal2.default(num.toString()).div(import_decimal2.default.pow(2, 64)).toDecimalPlaces(decimalPlaces);
  }
  static decimalToX64(num) {
    return new import_bn13.default(num.mul(import_decimal2.default.pow(2, 64)).floor().toFixed());
  }
...
var SqrtPriceMath = class _SqrtPriceMath {
  static sqrtPriceX64ToPrice(sqrtPriceX64, decimalsA, decimalsB) {
    return MathUtil.x64ToDecimal(sqrtPriceX64).pow(2).mul(import_decimal2.default.pow(10, decimalsA - decimalsB));
  }
  static priceToSqrtPriceX64(price, decimalsA, decimalsB) {
    return MathUtil.decimalToX64(price.mul(import_decimal2.default.pow(10, decimalsB - decimalsA)).sqrt());
  }
  ...
  static getSqrtPriceX64FromTick(tick) {
    ...
    if ((tickAbs & 2) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18444899583751176192"));
    if ((tickAbs & 4) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18443055278223355904"));
    if ((tickAbs & 8) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18439367220385607680"));
    if ((tickAbs & 16) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18431993317065453568"));
    if ((tickAbs & 32) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18417254355718170624"));
    if ((tickAbs & 64) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18387811781193609216"));
    if ((tickAbs & 128) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18329067761203558400"));
    if ((tickAbs & 256) != 0) ratio = mulRightShift(ratio, new import_bn13.default("18212142134806163456"));
    if ((tickAbs & 512) != 0) ratio = mulRightShift(ratio, new import_bn13.default("17980523815641700352"));
    if ((tickAbs & 1024) != 0) ratio = mulRightShift(ratio, new import_bn13.default("17526086738831433728"));
    if ((tickAbs & 2048) != 0) ratio = mulRightShift(ratio, new import_bn13.default("16651378430235570176"));
    if ((tickAbs & 4096) != 0) ratio = mulRightShift(ratio, new import_bn13.default("15030750278694412288"));
    if ((tickAbs & 8192) != 0) ratio = mulRightShift(ratio, new import_bn13.default("12247334978884435968"));
    if ((tickAbs & 16384) != 0) ratio = mulRightShift(ratio, new import_bn13.default("8131365268886854656"));
    if ((tickAbs & 32768) != 0) ratio = mulRightShift(ratio, new import_bn13.default("3584323654725218816"));
    if ((tickAbs & 65536) != 0) ratio = mulRightShift(ratio, new import_bn13.default("696457651848324352"));
    if ((tickAbs & 131072) != 0) ratio = mulRightShift(ratio, new import_bn13.default("26294789957507116"));
    if ((tickAbs & 262144) != 0) ratio = mulRightShift(ratio, new import_bn13.default("37481735321082"));
...
var LiquidityMath = class _LiquidityMath {
  ...
  static getAmountsFromLiquidityWithSlippage(sqrtPriceCurrentX64, sqrtPriceX64A, sqrtPriceX64B, liquidity, amountMax, roundUp, amountSlippage) {
    ...
    const amount0Slippage = new import_bn13.default(new import_decimal2.default(amountA.toString()).mul(coefficient).toFixed(0));
    const amount1Slippage = new import_bn13.default(new import_decimal2.default(amountB.toString()).mul(coefficient).toFixed(0));
    return {
  ...
  static swapStepCompute(sqrtPriceX64Current, sqrtPriceX64Target, liquidity, amountRemaining, feeRate) {
    ...
    if (baseInput) {
      const amountRemainingSubtractFee = MathUtil.mulDivFloor(
        amountRemaining,
        FEE_RATE_DENOMINATOR.sub(new import_bn13.default(feeRate.toString())),
    ...
    if (baseInput && !swapStep.sqrtPriceX64Next.eq(sqrtPriceX64Target)) {
      ...
      swapStep.feeAmount = MathUtil.mulDivCeil(
        ...
        FEE_RATE_DENOMINATOR.sub(new import_bn13.default(feeRate))
      );
    }
...
var Clmm = class extends Base {
  ...
  static makeOpenPositionFromLiquidityInstructions(_0) {
    return __async(this, arguments, function* ({
      ...
      const { publicKey: positionNftAccount } = getATAAddress(ownerInfo.wallet, nftMintAccount, import_spl_token.TOKEN_PROGRAM_ID);
  ...
  static makeIncreasePositionFromLiquidityInstructions({
    ...
    const { publicKey: positionNftAccount } = getATAAddress(ownerInfo.wallet, ownerPosition.nftMint, import_spl_token.TOKEN_PROGRAM_ID);
  ...
  static getLiquidityAmountOutFromAmountIn({
    ...
    const _amount = new import_bn15.default(
      new import_decimal3.default(addFeeAmount.amount.sub((_b = addFeeAmount.fee) != null ? _b : ZERO).toString()).mul(coefficient).toFixed(0)
    );
    let liquidity;
    if (sqrtPriceX64.lte(sqrtPriceX64A)) {
      liquidity = inputA ? LiquidityMath.getLiquidityFromTokenAmountA(sqrtPriceX64A, sqrtPriceX64B, _amount, !add) : new import_bn15.default(0);
      ...
      liquidity = inputA ? new import_bn15.default(0) : LiquidityMath.getLiquidityFromTokenAmountB(sqrtPriceX64A, sqrtPriceX64B, _amount);
    }
  ...
  static computeAmountOutFormat({
    ...
    const _currentPrice = new Price(
      ...
      currentPrice.mul(new import_decimal3.default(__pow(10, 20 + (currencyOut instanceof Token ? currencyOut : Token.WSOL).decimals))).toFixed(0)
    );
    const _executionPrice = new Price(
      amountInIsTokenAmount ? amountIn.token : amountIn.currency,
      new import_bn15.default(10).pow(new import_bn15.default(20 + (amountInIsTokenAmount ? amountIn.token : amountIn.currency).decimals)),
      currencyOut instanceof Token ? currencyOut : Token.WSOL,
      executionPrice.mul(new import_decimal3.default(__pow(10, 20 + (currencyOut instanceof Token ? currencyOut : Token.WSOL).decimals))).toFixed(0)
    );
...
var SERUM_PROGRAM_ID_V3 = new import_web319.PublicKey(_SERUM_PROGRAM_ID_V3);
  ...
  static getAssociatedAuthority({ programId, marketId }) {
    ...
    while (nonce < 100) {
      try {
        ...
        publicKey2 = import_web320.PublicKey.createProgramAddressSync(seedsWithNonce, programId);
      } catch (err) {
...
var LIQUIDITY_FEES_NUMERATOR = new import_bn16.default(25);
var LIQUIDITY_FEES_DENOMINATOR = new import_bn16.default(1e4);
var _Liquidity = class _Liquidity extends Base {
  ...
  static makeAddLiquidityInstruction(params) {
    ...
    if (version2 === 4 || version2 === 5) {
      ...
      return {
        ...
        innerTransaction: {
          instructions: [
            new import_web322.TransactionInstruction({
              programId: poolKeys.programId,
              keys,
              data
            })
          ...
          signers: [],
          lookupTableAddress: [poolKeys.lookupTableAccount].filter((i) => i && !i.equals(import_web322.PublicKey.default)),
  ...
  static makeCreatePoolV4InstructionV2Simple(_0) {
    return __async(this, arguments, function* ({
      ...
      const ins = this.makeCreatePoolV4InstructionV2({
        ...
        userLpVault: getATAAddress(ownerInfo.wallet, poolInfo.lpMint, import_spl_token.TOKEN_PROGRAM_ID).publicKey,
  ...
  static makeCreatePoolV4InstructionV2({
    ...
    const ins = new import_web322.TransactionInstruction({
      keys,
      programId,
      data
    });
  ...
  static makeRemoveAllLpAndCreateClmmPosition(_0) {
    return __async(this, arguments, function* ({
      ...
      for (const item of userKeys.tokenAccounts) {
        if (mintToAccount[item.accountInfo.mint.toString()] === void 0 || getATAAddress(userKeys.owner, item.accountInfo.mint, import_spl_token.TOKEN_PROGRAM_ID).publicKey.equals(item.pubkey)) {
  ...
  static fetchAllPoolKeys(connection, programId, config) {
    return __async(this, null, function* () {
      ...
      for (const pool of allPools) {
        ...
        if (pool.baseMint.equals(import_web322.PublicKey.default)) continue;
        ...
        formatPoolInfos.push(__spreadProps(__spreadValues({
          ...
          withdrawQueue: import_web322.PublicKey.default,
          lpVault: import_web322.PublicKey.default
        } : {
  ...
  static fetchMultipleInfo(_0) {
    return __async(this, arguments, function* ({
      ...
      const poolsInfo = logs.map((log) => {
        ...
        const status = new import_bn16.default(parseSimulateValue(json, "status"));
        ...
        const baseReserve = new import_bn16.default(parseSimulateValue(json, "pool_coin_amount"));
        const quoteReserve = new import_bn16.default(parseSimulateValue(json, "pool_pc_amount"));
        const lpSupply = new import_bn16.default(parseSimulateValue(json, "pool_lp_supply"));
        let startTime = "0";
        try {
...
_Liquidity.computeAmountOut = ({
  ...
  if (poolKeys.version === 4) {
    ...
    if (input === "quote") currentPrice = new Price(currencyIn, new import_bn16.default(p * 1e6), currencyOut, new import_bn16.default(1e6));
    else currentPrice = new Price(currencyIn, new import_bn16.default(1e6), currencyOut, new import_bn16.default(p * 1e6));
  }
  logger11.debug("currentPrice:", `1 ${currencyIn.symbol} \u2248 ${currentPrice.toFixed()} ${currencyOut.symbol}`);
  logger11.debug(
    "currentPrice invert:",
...
function makeInnerInsKey(itemPool, inMint, userInAccount, userOutAccount, remainingAccount) {
  if (itemPool.version === 4) {
    ...
    return [
      ...
      {
        pubkey: getPdaExBitmapAccount(new import_web324.PublicKey(String(itemPool.programId)), itemPool.id).publicKey,
        isSigner: false,
        isWritable: true
      }
    ];
...
var TradeV2 = class extends Base {
  static getAllRoute({
      ...
      for (const infoIn of info.in) {
        for (const infoOut of info.out) {
          if (infoIn.version === 6 && needTickArray[infoIn.id.toString()] === void 0) {
            ...
            if (infoIn.mintA.programId.equals(import_spl_token8.TOKEN_2022_PROGRAM_ID)) needCheckToken.add(infoIn.mintA.mint.toString());
            if (infoIn.mintB.programId.equals(import_spl_token8.TOKEN_2022_PROGRAM_ID)) needCheckToken.add(infoIn.mintB.mint.toString());
          ...
          if (infoOut.version === 6 && needTickArray[infoOut.id.toString()] === void 0) {
            ...
            if (infoOut.mintA.programId.equals(import_spl_token8.TOKEN_2022_PROGRAM_ID)) needCheckToken.add(infoOut.mintA.mint.toString());
            if (infoOut.mintB.programId.equals(import_spl_token8.TOKEN_2022_PROGRAM_ID)) needCheckToken.add(infoOut.mintB.mint.toString());
    ...
    for (const item of directPath) {
      if (item.version === 6) {
        if (item.mintA.programId.equals(import_spl_token8.TOKEN_2022_PROGRAM_ID)) needCheckToken.add(item.mintA.mint.toString());
        if (item.mintB.programId.equals(import_spl_token8.TOKEN_2022_PROGRAM_ID)) needCheckToken.add(item.mintB.mint.toString());
      }
    }
    return {
      directPath,
...
var MarketV2 = class extends Base {
  static makeCreateMarketInstructionSimple(_0) {
    return __async(this, arguments, function* ({
      ...
      const baseVault = generatePubKey({ fromPublicKey: wallet, programId: import_spl_token.TOKEN_PROGRAM_ID });
      const quoteVault = generatePubKey({ fromPublicKey: wallet, programId: import_spl_token.TOKEN_PROGRAM_ID });
      const feeRateBps = 0;
  ...
  static initializeMarketInstruction({
    ...
    const keys = [
      ...
      {
        pubkey: marketInfo.authority ? marketInfo.quoteMint : import_web33.SYSVAR_RENT_PUBKEY,
        isSigner: false,
        isWritable: false
      }
