...
export declare const CondensedBlock: {
  ...
  create<
    I extends {
      ...
      slot?: number | undefined;
      commitment?: string | undefined;
    } & {[K_2 in Exclude<keyof I, keyof CondensedBlock>]: never}
  >(
    base?: I | undefined
  ): CondensedBlock;
  fromPartial<
    I_1 extends {
      ...
      header?:
        | ({
            ...
            ts?: Date | undefined;
          } & {[K_3 in Exclude<keyof I_1['header'], 'ts'>]: never})
        | undefined;
      previousBlockhash?: string | undefined;
      blockhash?: string | undefined;
      parentSlot?: number | undefined;
      versionedTransactions?:
        | (Uint8Array[] &
            Uint8Array[] & {
              [K_4 in Exclude<
                keyof I_1['versionedTransactions'],
                keyof Uint8Array[]
              >]: never;
            })
        | undefined;
      slot?: number | undefined;
      commitment?: string | undefined;
    } & {[K_5 in Exclude<keyof I_1, keyof CondensedBlock>]: never}
  >(
    object: I_1
  ): CondensedBlock;
};
