    ...
    I extends {
      ...
      socket?:
        | ({
            ...
            ip?: string | undefined;
            port?: number | undefined;
          } & {[K in Exclude<keyof I['socket'], keyof Socket>]: never})
        | undefined;
      regions?:
        | (string[] &
            string[] & {
              [K_1 in Exclude<keyof I['regions'], keyof string[]>]: never;
            })
        | undefined;
    } & {[K_2 in Exclude<keyof I, keyof Heartbeat>]: never}
  >(
    base?: I | undefined
  ): Heartbeat;
  fromPartial<
    I_1 extends {
      ...
      socket?:
        | ({
            ...
            ip?: string | undefined;
            port?: number | undefined;
          } & {[K_3 in Exclude<keyof I_1['socket'], keyof Socket>]: never})
        | undefined;
      regions?:
        | (string[] &
            string[] & {
              [K_4 in Exclude<keyof I_1['regions'], keyof string[]>]: never;
            })
        | undefined;
    } & {[K_5 in Exclude<keyof I_1, keyof Heartbeat>]: never}
  >(
    object: I_1
  ): Heartbeat;
};
export declare const HeartbeatResponse: {
  ...
  create<
    I extends {
      ...
      ttlMs?: number | undefined;
    } & {[K in Exclude<keyof I, 'ttlMs'>]: never}
  >(
    base?: I | undefined
  ): HeartbeatResponse;
  fromPartial<
    I_1 extends {
      ...
      ttlMs?: number | undefined;
    } & {[K_1 in Exclude<keyof I_1, 'ttlMs'>]: never}
  >(
    object: I_1
  ): HeartbeatResponse;
};
