...
export declare const GetTpuConfigsRequest: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I | undefined): GetTpuConfigsRequest;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): GetTpuConfigsRequest;
};
export declare const GetTpuConfigsResponse: {
    ...
    create<I extends {
        ...
        tpu?: ({
            ...
            ip?: string | undefined;
            port?: number | undefined;
        } & { [K in Exclude<keyof I["tpu"], keyof Socket>]: never; }) | undefined;
        tpuForward?: ({
            ip?: string | undefined;
            port?: number | undefined;
        } & {
            ip?: string | undefined;
            port?: number | undefined;
        } & { [K_1 in Exclude<keyof I["tpuForward"], keyof Socket>]: never; }) | undefined;
    } & { [K_2 in Exclude<keyof I, keyof GetTpuConfigsResponse>]: never; }>(base?: I | undefined): GetTpuConfigsResponse;
    fromPartial<I_1 extends {
        ...
        tpu?: ({
            ...
            ip?: string | undefined;
            port?: number | undefined;
        } & { [K_3 in Exclude<keyof I_1["tpu"], keyof Socket>]: never; }) | undefined;
        tpuForward?: ({
            ip?: string | undefined;
            port?: number | undefined;
        } & {
            ip?: string | undefined;
            port?: number | undefined;
        } & { [K_4 in Exclude<keyof I_1["tpuForward"], keyof Socket>]: never; }) | undefined;
    } & { [K_5 in Exclude<keyof I_1, keyof GetTpuConfigsResponse>]: never; }>(object: I_1): GetTpuConfigsResponse;
};
...
export declare const SubscribePacketsResponse: {
    ...
    create<I extends {
        ...
        heartbeat?: ({
            ...
            count?: number | undefined;
        } & { [K_1 in Exclude<keyof I["heartbeat"], "count">]: never; }) | undefined;
        batch?: ({
            packets?: {
                data?: Uint8Array | undefined;
                meta?: {
            ...
            packets?: ({
                ...
                meta?: ({
                    ...
                    flags?: ({
                        ...
                        simpleVoteTx?: boolean | undefined;
                        tracerPacket?: boolean | undefined;
                    } & { [K_2 in Exclude<keyof I["batch"]["packets"][number]["meta"]["flags"], keyof import("./packet").PacketFlags>]: never; }) | undefined;
                    senderStake?: number | undefined;
                } & { [K_3 in Exclude<keyof I["batch"]["packets"][number]["meta"], keyof import("./packet").Meta>]: never; }) | undefined;
            } & { [K_4 in Exclude<keyof I["batch"]["packets"][number], keyof import("./packet").Packet>]: never; })[] & { [K_5 in Exclude<keyof I["batch"]["packets"], keyof {
                data?: Uint8Array | undefined;
                meta?: {
                    size?: number | undefined;
                    addr?: string | undefined;
        ...
        } & { [K_6 in Exclude<keyof I["batch"], "packets">]: never; }) | undefined;
    } & { [K_7 in Exclude<keyof I, keyof SubscribePacketsResponse>]: never; }>(base?: I | undefined): SubscribePacketsResponse;
    fromPartial<I_1 extends {
        header?: {
            ts?: Date | undefined;
        } | undefined;
        ...
        header?: ({
            ...
            ts?: Date | undefined;
        } & { [K_8 in Exclude<keyof I_1["header"], "ts">]: never; }) | undefined;
        heartbeat?: ({
            count?: number | undefined;
        } & {
            count?: number | undefined;
        } & { [K_9 in Exclude<keyof I_1["heartbeat"], "count">]: never; }) | undefined;
        batch?: ({
            packets?: {
                data?: Uint8Array | undefined;
                meta?: {
            ...
            packets?: ({
                ...
                meta?: ({
                    ...
                    flags?: ({
                        ...
                        simpleVoteTx?: boolean | undefined;
                        tracerPacket?: boolean | undefined;
                    } & { [K_10 in Exclude<keyof I_1["batch"]["packets"][number]["meta"]["flags"], keyof import("./packet").PacketFlags>]: never; }) | undefined;
                    senderStake?: number | undefined;
                } & { [K_11 in Exclude<keyof I_1["batch"]["packets"][number]["meta"], keyof import("./packet").Meta>]: never; }) | undefined;
            } & { [K_12 in Exclude<keyof I_1["batch"]["packets"][number], keyof import("./packet").Packet>]: never; })[] & { [K_13 in Exclude<keyof I_1["batch"]["packets"], keyof {
                data?: Uint8Array | undefined;
                meta?: {
                    size?: number | undefined;
                    addr?: string | undefined;
        ...
        } & { [K_14 in Exclude<keyof I_1["batch"], "packets">]: never; }) | undefined;
    } & { [K_15 in Exclude<keyof I_1, keyof SubscribePacketsResponse>]: never; }>(object: I_1): SubscribePacketsResponse;
};
/**
