...
export declare const Header: {
  ...
  fromPartial<
    I_1 extends {
      ...
      ts?: Date | undefined;
    } & {[K_1 in Exclude<keyof I_1, 'ts'>]: never}
  >(
    object: I_1
  ): Header;
};
export declare const Heartbeat: {
  ...
  create<
    I extends {
      ...
      count?: number | undefined;
    } & {[K in Exclude<keyof I, 'count'>]: never}
  >(
    base?: I | undefined
  ): Heartbeat;
  fromPartial<
    I_1 extends {
      ...
      count?: number | undefined;
    } & {[K_1 in Exclude<keyof I_1, 'count'>]: never}
  >(
    object: I_1
  ): Heartbeat;
};
export declare const Socket: {
  ...
  create<
    I extends {
      ...
      ip?: string | undefined;
      port?: number | undefined;
    } & {[K in Exclude<keyof I, keyof Socket>]: never}
  >(
    base?: I | undefined
  ): Socket;
  fromPartial<
    I_1 extends {
      ...
      ip?: string | undefined;
      port?: number | undefined;
    } & {[K_1 in Exclude<keyof I_1, keyof Socket>]: never}
  >(
    object: I_1
  ): Socket;
};
